defmodule Absinthe.Object.Dataloader.BatchKeyTest do
  use ExUnit.Case, async: true

  alias Absinthe.Object.Dataloader.BatchKey
  ...
  defmodule Organization do
    ...
    schema "organizations" do
      field :name, :string
      has_many :users, Absinthe.Object.Dataloader.BatchKeyTest.User
    end
  end
  ...
  defmodule User do
    ...
    schema "users" do
      ...
      has_many :posts, Absinthe.Object.Dataloader.BatchKeyTest.Post
    end
  end
