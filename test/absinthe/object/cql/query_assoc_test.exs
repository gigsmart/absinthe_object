defmodule Absinthe.Object.CQL.QueryAssocTest do
  use ExUnit.Case, async: true

  alias Absinthe.Object.CQL.QueryAssoc
  ...
  defmodule Organization do
    ...
    schema "organizations" do
      field :name, :string
      has_many :users, Absinthe.Object.CQL.QueryAssocTest.User
    end
  end
  ...
  defmodule User do
    ...
    schema "users" do
      ...
      has_many :posts, Absinthe.Object.CQL.QueryAssocTest.Post
    end
  end
