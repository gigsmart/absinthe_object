defmodule Mix.Tasks.Absinthe.Object.Gen.Schema do
  @shortdoc "Generates an Absinthe.Object schema module"

  @moduledoc """
  Generates an Absinthe.Object schema module with auto-discovery.
