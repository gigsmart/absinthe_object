defmodule Absinthe.Object.Adapters.Ecto.Postgres do
  @moduledoc """
  ...
  extensions like PostGIS. The `Absinthe.Object.Filter` protocol dispatches
  ...
  ## Example
      ...
      adapter = Absinthe.Object.Adapters.Ecto.Postgres.new(MyApp.Repo,
        extensions: [:postgis]
      )

      # Check extension availability
      Absinthe.Object.Adapters.Ecto.Postgres.postgis?(adapter)
      #=> true
