defmodule Absinthe.Object.Adapters.Ecto.MySQL do
  @moduledoc """
  MySQL adapter struct for filter protocol dispatch.

  This struct represents a MySQL database connection. The `Absinthe.Object.Filter`
  ...
  ## Example
      ...
      adapter = Absinthe.Object.Adapters.Ecto.MySQL.new(MyApp.Repo,
        version: "8.0.28"
      )

      # Check spatial support (requires MySQL 8.0+)
      Absinthe.Object.Adapters.Ecto.MySQL.spatial?(adapter)
      #=> true
