defmodule Absinthe.Object.Adapters.Ecto.Detector do
  @moduledoc """
  ...
  ## Usage
      ...
      adapter = Absinthe.Object.Adapters.Ecto.Detector.adapter_for(MyApp.Repo)
      #=> %Absinthe.Object.Adapters.Ecto.Postgres{repo: MyApp.Repo, extensions: []}
  ...
  alias Absinthe.Object.Adapters.Ecto.{Postgres, MySQL, SQLite}
    ...
    case adapter_for(repo, opts) do
      {:error, {:unknown_adapter, ecto_adapter}} ->
        ...
        You can manually create an adapter:
            ...
            Absinthe.Object.Adapters.Ecto.Postgres.new(#{inspect(repo)})
