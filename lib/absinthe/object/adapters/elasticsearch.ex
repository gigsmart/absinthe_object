defmodule Absinthe.Object.Adapters.Elasticsearch do
  @moduledoc """
  Elasticsearch adapter struct for filter protocol dispatch.

  This struct represents an Elasticsearch connection. The `Absinthe.Object.Filter`
  ...
  ## Example
      ...
      adapter = Absinthe.Object.Adapters.Elasticsearch.new(
