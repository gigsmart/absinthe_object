defmodule Absinthe.Object.Mutation do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      import Absinthe.Object.Mutation, only: [mutations: 1]

      Module.register_attribute(__MODULE__, :absinthe_object_mutations, accumulate: false)

      @before_compile Absinthe.Object.Mutation
    end
  end
  ...
  defmacro mutations(do: block) do
    quote do
      @absinthe_object_mutations true

      # Store the block for later extraction by the schema
      def __absinthe_object_mutation_fields__ do
        unquote(Macro.escape(block))
      end

      # Define mutations object that can be imported
      object :absinthe_object_mutations do
        unquote(block)
      end
    end
  end
  ...
  defmacro __before_compile__(env) do
    has_mutations = Module.get_attribute(env.module, :absinthe_object_mutations)
