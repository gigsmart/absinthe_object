defmodule Absinthe.Object do
  ...
  ### Operations
  - `Absinthe.Object.Query` - Define query fields (grouped with mutations/subscriptions)
  - `Absinthe.Object.Mutation` - Define mutation fields (grouped with queries/subscriptions)
  - `Absinthe.Object.Subscription` - Define subscription fields (grouped with queries/mutations)
  - `Absinthe.Object.Operations` - Define all operations in one module

  ### Root Types (Standalone)
  - `Absinthe.Object.RootQuery` - Define root query module
  - `Absinthe.Object.RootMutation` - Define root mutation module
  - `Absinthe.Object.RootSubscription` - Define root subscription module
