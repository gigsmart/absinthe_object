defmodule GreenFairy.Adapter do
  @moduledoc """
  ...
  - `GreenFairy.Adapters.Ecto` - For Ecto schemas
  """
  ...
  @default_adapters [GreenFairy.Adapters.Ecto]
  ...
  def configured_adapters do
    Application.get_env(:green_fairy, :adapters, [])
  end
